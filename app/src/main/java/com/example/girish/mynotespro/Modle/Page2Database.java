...
public class Page2Database extends SQLiteOpenHelper {

    private static final String DB_NAME = "Page2.db";
    private static final String DB_TABLE = "Page2_Table";
    ...
    public Page2Database(Context context){
    ...
    public Cursor seach(String title){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM Page2_Table WHERE TITLE='"+title+"'",null);
        return res;
    }
