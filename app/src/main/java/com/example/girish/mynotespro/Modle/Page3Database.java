...
public class Page3Database extends SQLiteOpenHelper {

    private static final String DB_NAME = "Page3.db";
    private static final String DB_TABLE = "Page3_Table";
    ...
    public Page3Database(Context context){
    ...
    public Cursor seach(String title){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM Page3_Table WHERE TITLE='"+title+"'",null);
        return res;
    }
