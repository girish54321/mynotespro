...
public class Page5Database extends SQLiteOpenHelper {

    private static final String DB_NAME = "Page5.db";
    private static final String DB_TABLE = "Page5_Table";
    ...
    public Page5Database(Context context){
    ...
    public Cursor seach(String title){
        SQLiteDatabase db = this.getWritableDatabase();
        Cursor res = db.rawQuery("SELECT * FROM Page5_Table WHERE TITLE='"+title+"'",null);
        return res;
    }
